...
class AccessProvidedAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "data_run_object",
        "project_access_type",
        "data_run_access_type",
        "created_at",
    )
    search_fields = (
        "user_object__username",
        "project_object__project_key",
        "data_run_object__data_run_key",
    )
...
class ProviderAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name", "client_id", "auth_url", "token_url", "base_url")
