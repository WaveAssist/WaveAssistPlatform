...
def refresh_prices(df):
    ...
    for key, value in all_quotes.items():
        try:
            ...
            historical_data = kite.historical_data(instrument_token, from_str, today_str, 'day', continuous=False,
                                                   oi=False)
...
if should_email_summary:
    ...
    df = df[
        ['symbol', 'buy_amount', 'current_price', 'yesterday_close', 'current_amount', 'high', 'low', 'today_p&l',
         'today_p&l_amount', 'today_p&l_percent',
