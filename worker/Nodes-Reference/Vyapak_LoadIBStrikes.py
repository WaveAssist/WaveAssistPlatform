...
try:
    ...
    should_refresh = int(vyapak_input[vyapak_input['name'] == 'should_refresh_ib']['value'].values[0])
    ...
    vyapak_input['value'][vyapak_input['name'] == 'should_refresh_ib'] = 0
    print("All IB data updated!!!!!" + str(len(all_crude_oil_dict_array)))

    return output_df, vyapak_input
