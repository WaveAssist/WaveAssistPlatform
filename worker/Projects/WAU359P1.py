def WAU359P1N1(WAU359P1D1, ):
    ...
    try:
        ...
        zerodha_api_key = WAU359P1D1[WAU359P1D1['name'] == 'zerodha_api_key']['value'].values[0]
        access_token = WAU359P1D1[WAU359P1D1['name'] == 'zerodha_access_token']['value'].values[0]
        ...
        zerodha_futures_dict = {
            ...
            'zerodha_symbol': zerodha_future_symbol,
