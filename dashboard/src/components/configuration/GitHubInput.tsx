	...
	if (isConfigured && value !== "connecting") {
		return (
			<div className="github-input-container">
				<div className="d-flex align-items-center justify-content-between p-3 border rounded" style={{ backgroundColor: "#f8f9fa", borderColor: "#e9ecef" }}>
					<div className="d-flex align-items-center gap-3">
						...
						<div>
							<div className="fw-medium" style={{ fontSize: "0.95rem" }}>GitHub Integration</div>
